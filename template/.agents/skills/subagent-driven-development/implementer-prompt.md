...
Subagent (general-purpose):
  ...
  prompt: |
    ...
    **Ask them now.** Raise any concerns before starting work.
    ...
    3. Receive test results via superpowers:receiving-test-creation and verify implementation works
    4. Commit your work
    ...
    **Testing:**
    ...
    - Did I follow the superpowers:requesting-test-creation / superpowers:receiving-test-creation loop if TDD was required?
